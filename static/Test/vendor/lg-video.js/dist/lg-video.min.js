...
!function (e) {
    ...
    return function () {
        function e(o, i, t) {
            ...
            for (var r = "function" == typeof require && require, a = 0; a < t.length; a++) l(t[a]);
            return l
        }
                ...
                i.prototype.init = function () {
                    ...
                    var o = function o(i) {
                        if (utils.hasClass(i.querySelector(".lg-object"), "lg-has-poster") && "none" !== i.querySelector(".lg-object").style.display) if (utils.hasClass(i, "lg-has-video")) {
                            var t = i.querySelector(".lg-youtube"), l = i.querySelector(".lg-vimeo"),
                                r = i.querySelector(".lg-dailymotion"), a = i.querySelector(".lg-html5");
                    ...
                    if (e.core.doCss() && e.core.items.length > 1 && (e.core.s.enableSwipe && e.core.isTouch || e.core.s.enableDrag && !e.core.isTouch)) utils.on(e.core.el, "onSlideClick.lgtm", function () {
                        ...
                        o(i)
                    }); else for (var i = 0; i < e.core.___slide.length; i++) !function (i) {
                        utils.on(e.core.___slide[i], "click.lg", function () {
                            o(e.core.___slide[i])
                        })
                    }(i);
                    utils.on(e.core.el, "onBeforeSlide.lgtm", function (o) {
                        var i = e.core.___slide[o.detail.prevIndex], t = i.querySelector(".lg-youtube"),
                            l = i.querySelector(".lg-vimeo"), r = i.querySelector(".lg-dailymotion"),
                            a = i.querySelector(".lg-vk"), s = i.querySelector(".lg-html5");
                    ...
                    var r = "", a = 1, s = "", d = this.core.isVideo(e, t) || {};
