        ...
        1: [function (t, s, l) {
            ...
            !function (s, i) {
                ...
                s.prototype.init = function () {
                    ...
                    var i = this, o = !1, r, a, d, n, u, c, g, f = function e(t) {
                    ...
                    if (!l.default.hasClass(i.___slide[e], "lg-loaded")) {
                        ...
                        if (l.default.trigger(i.el, "onAferAppendSlide", {index: e}), r = i.___slide[e].querySelector(".lg-object"), u && r.setAttribute("sizes", u), n && (r.setAttribute("srcset", n), this.s.supportLegacyBrowser)) try {
                    ...
                    var r = this;
                    if (!r.lGalleryOn || i !== e) {
                        var a = this.___slide.length, d = r.lGalleryOn ? this.s.speed : 0, n = !1, u = !1;
                        if (!r.lgBusy) {
                            if (this.s.download) {
                                var c;
