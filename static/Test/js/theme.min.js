...
!function () {
    ...
    null != (r = document.querySelector(".navbar-sticky")) && (r.classList, t = r.offsetHeight, window.addEventListener("scroll", function (e) {
        ...
        var e = document.querySelectorAll('[data-bs-toggle="offcanvas"]'),
            t = document.querySelectorAll('[data-bs-dismiss="offcanvas"]'), r = document.querySelectorAll(".offcanvas"),
            a = document.body, n = document.querySelectorAll("[data-fixed-element]"),
            o = window.innerWidth > a.clientWidth, l = document.createElement("div");
