...
class User(models.Model):
    ...
    username = models.CharField(max_length=64, unique=True, index=True)
...
class Note(models.Model):
    ...
    timestamp = models.DateTimeField(default=timezone.now, index=True)
    uid = models.ForeignKey(User, on_delete=models.CASCADE)
    important = models.IntegerField(default=0)
    recent_activity = models.DateTimeField(default=timezone.now, index=True)
